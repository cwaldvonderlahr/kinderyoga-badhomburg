        ...
        <div class="relative lg:ml-10">
          ...
          <blockquote class="relative">
            <div class="text-2xl leading-9 font-medium text-gray-900">
              <p>
                Wenn ich mir einen Traum erfüllen könnte, dann wäre es Kindern Spaß am Yoga zu vermitteln.
              </p>
            </div>
            <footer class="mt-8">
              <div class="flex">
                ...
                <div class="ml-4 lg:ml-0">
                  <div class="text-base font-medium text-gray-900">Claudia Röske</div>
                  <div class="text-base font-medium text-indigo-600">Inhaberin - Kinderyoga Bad Homburg</div>
                </div>
              </div>
            </footer>
          </blockquote>
